...
- رقم هوية `ولي الأمر` يجب أن يكون `10 أرقام` فقط.
- رقم هوية `السائق` يجب أن يكون `10 أرقام`.
- يوجد خيار `حفظ كلمة السر` في شاشة تسجيل الدخول.

### تدفق ولي الأمر الجديد (بعد تسجيل الدخول)

1. افتح لوحة ولي الأمر.
2. حدّد `موقع الوصول الثابت` مرة واحدة (هذا الموقع مشترك لكل الطلاب).
3. اضغط `إضافة طالب` ثم أدخل:
	- هوية الطالب (10 أرقام)
	- تاريخ الميلاد
	- موقع الاستلام
	- وقت الاستلام
	- وقت العودة
4. يمكنك إضافة أكثر من طالب لنفس ولي الأمر.
5. كل طالب يظهر داخل اللوحة بمعرف مختصر `ID`.
6. من زر الخريطة داخل لوحة ولي الأمر يمكنك فتح صفحة `موقع السواق لايف`.
...
## 5.0) مهم بعد التحديثات الجديدة: نشر قواعد Firestore

لضمان صلاحيات الطلاب حسب `parentId`:
